...
case "${TIER}" in
  1) DEFAULT_BASE="http://127.0.0.1:8081"; MODEL="/models/Qwen2.5-0.5B-Instruct-Q4_0.gguf"; SERVICE="tier1" ;;
  2) DEFAULT_BASE="http://127.0.0.1:8082"; MODEL="/models/Qwen2.5-3B-Instruct-Q4_0.gguf"; SERVICE="tier2" ;;
