#!/usr/bin/env python3
"""KV compression / tier migration benchmark."""
...
async def main() -> None:
    ...
    try:
        result = await run_named_benchmark(runtime, "compress", iterations=10)
        write_report(ROOT / "work" / "benchmarks" / "kv_compress.json", [result])
        print(result)
    finally:
        runtime.shutdown()
