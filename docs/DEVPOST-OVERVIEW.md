...
**Performix pack (in-repo):** [`docs/evidence/performix/OPTIMIZATIONS.md`](evidence/performix/OPTIMIZATIONS.md) · [`01-code_hotspots.json`](evidence/performix/01-code_hotspots.json) (`source=apx`, libggml-cpu ~79%) · flame [`screenshots/05-code-hotspots-flame.png`](evidence/performix/screenshots/05-code-hotspots-flame.png) · Kleidi vs stock [`COMPARISON.md`](evidence/performix/COMPARISON.md).
...
- Arm Performix: `docs/evidence/performix/OPTIMIZATIONS.md` + flame PNG + `01-code_hotspots.json`
