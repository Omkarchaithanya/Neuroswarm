"""ExecuTorch inference backend stub."""
...
class ExecuTorchBackend(InferenceBackend):
    """Placeholder ExecuTorch backend — not wired in this build."""
    ...
    async def health(self) -> HealthStatus:
        return HealthStatus(
            ...
            message="executorch unavailable (not wired)",
    ...
    async def prefill(self, req: PrefillRequest, ctx: ExecutionContext) -> PrefillResult:
        raise RuntimeError("executorch not wired")
