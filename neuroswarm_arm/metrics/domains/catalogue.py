...
DOMAIN_METRICS: tuple[MetricDef, ...] = (
    ...
    _g("nexus_performix_hotspot_top_pct", "Top hotspot percent of samples", MetricDomain.PERFORMIX),
    _g("nexus_performix_hotspot_count", "Number of hotspots in last recipe", MetricDomain.PERFORMIX),
    ...
    # ASCR / ArmCascade (aliases keep ascr_* series for Grafana)
    _g("nexus_ascr_acceptance_rate", "Token/prefix acceptance rate", MetricDomain.DIPA, aliases=("ascr_acceptance_rate",)),
    _g("nexus_ascr_speculation_gain", "Speculative gain (0 when text-agree interim)", MetricDomain.DIPA, aliases=("ascr_speculation_gain",)),
    _c("nexus_ascr_quality_cascade_total", "Requests in quality-cascade mode", MetricDomain.DIPA, aliases=("ascr_quality_cascade_total",)),
    _g("nexus_ascr_text_agreement", "Text-agreement score when logits unavailable", MetricDomain.DIPA, aliases=("ascr_text_agreement",)),
    _g("nexus_dipa_cascade_hit_rate", "Tier-1 finish fraction", MetricDomain.DIPA, aliases=("dipa_cascade_hit_rate",)),
    _c("nexus_ascr_rounds_total", "ASCR propose/verify rounds", MetricDomain.DIPA, aliases=("ascr_rounds_total",)),
    # 12 Energy
